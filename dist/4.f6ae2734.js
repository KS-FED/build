	        ...
	        return {
	            data: [{ label: '功能', checked: true,
	                children: [{ label: '门店', checked: true,
	                    children: [{ label: '查询', checked: true, current: false }, { label: '编辑', checked: true, current: false }] }, { label: '营销', checked: true,
	                    children: [{ label: '查询', checked: true, current: false }, { label: '编辑', checked: true, current: false }] }, { label: '会员卡', checked: true,
	                    children: [{ label: '查询', checked: true, current: false }, { label: '编辑', checked: true, current: false }] }, { label: '储值卡', checked: true,
	                    children: [{ label: '查询', checked: true, current: false }, { label: '编辑', checked: true, current: false }] }, { label: '积分卡', checked: true, current: false }, { label: '现金红包', checked: true, current: false }] }, { label: '管理', checked: true,
	                children: [{ label: '会员管理', checked: true, current: false }, { label: '财务对账', checked: true, current: false }] }, { label: '设置', checked: true,
